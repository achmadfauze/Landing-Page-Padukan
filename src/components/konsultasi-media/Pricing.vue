...
const plans: PlanProps[] = [
  {
    ...
    price: 150000,
    description:
      "Paket awal untuk bisnis yang ingin mulai mengelola media secara lebih terstruktur.",
    buttonText: "Langganan Basic",
    benefitList: [
      "Audit media dan evaluasi kebutuhan dasar",
      "Rekomendasi strategi media sederhana",
      "Pelaporan performa media bulanan",
      "Sesi konsultasi 1x per bulan",
    ],
  },
  {
    title: "Premium",
    ...
    price: 300000,
    description:
      "Paket lengkap untuk bisnis yang ingin meningkatkan efektivitas pengelolaan media dan komunikasi.",
    buttonText: "Langganan Premium",
    benefitList: [
      "Audit dan analisis media menyeluruh",
      "Perencanaan strategi media multi-platform",
      "Pelatihan dan pendampingan tim internal",
      "Pelaporan performa dan insight mingguan",
      "Sesi konsultasi hingga 4x per bulan",
    ],
  },
  {
    title: "Enterprise",
    ...
    price: 600000,
    description:
      "Solusi strategis lengkap untuk perusahaan besar dengan kebutuhan pengelolaan media kompleks dan tim khusus.",
    buttonText: "Hubungi Kami",
    benefitList: [
      "Audit mendalam & pengembangan strategi menyeluruh",
      "Manajemen dan optimasi media secara langsung",
      "Pelatihan intensif dan coaching tim internal",
      "Pelaporan real-time dan dashboard khusus",
      "Konsultasi unlimited dan support dedicated",
    ],
  },
];
</script>
